                                            ...
                                            <table class="table table-borderless table-striped align-middle table-sm fs-14 mb-0">
                                                ...
                                                @foreach($operacionesrep as $index => $row)
                                                    <tr>
                                                        ...
                                                        <td align="center">{{($row->tipo =='P' or $row->tipo == 'O'  or $row->tipo == 'N' or $row->tipo =='T' or $row->tipo == 'K'  or $row->tipo == 'S')?$row->dep2: ''}}</td>
                                                        <td align="right">{{number_format($row->costo,2,',','.')}}</td>
                                                        <td align="right">{{($row->tipo =='A' or $row->tipo == 'B' or $row->tipo =='Z' or $row->tipo == 'W'  )?number_format($row->precio,2,',','.') :''}}</td>
