...
<div class="modal fade flip" id="descargarOrder" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body p-5 text-center">
                <lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop"
                ...
                <div class="mt-4 text-center">
                    <h4>¿Desea reconfigurar para descargar esta transferencia?</h4>
                    <p class="text-muted fs-15 mb-4">
                        La transferencia se podrá volver a descargar
                    </p>
                    <div class="hstack gap-2 justify-content-center remove" id="cargandodesc">
                        <button class="btn btn-link link-success fw-medium text-decoration-none"
                                id="deleteRecord-close" data-bs-dismiss="modal">
                            <i class="ri-close-line me-1 align-middle"></i> Cancelar
                        </button>
                        @if(auth()->user()->can('menu_transferencias_pendiente'))
                            <button class="btn btn-warning" id="descargarrecord" data-id="" type="button">
                                Sí, configurar
                            </button>
                        @endif
                    </div>
