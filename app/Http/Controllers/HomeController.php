    ...
    public function reporteventasucu(Request $request)
    {
        ...
        if($fec1 != ''){
            ...
            $montos = Saipavta::select([
                ...
                'f.codoper',
                'b.clase',
                DB::raw("(CASE f.TipoFac WHEN 'A' THEN saipavta.monto
        ...
        if($fec1 != ''){
            ...
            $montos = Saipavta::select([
                ...
                'f.codoper',
                'b.clase',
                DB::raw("(CASE f.TipoFac WHEN 'A' THEN saipavta.dolares
                                               WHEN 'Z' THEN saipavta.dolares
                                               WHEN 'B' THEN (saipavta.dolares * -1)
                                               WHEN 'W' THEN (saipavta.dolares * -1)  ELSE 0 END) as dolares"),
                DB::raw("b.descrip as tarjeta"),
                DB::raw("c.descrip as sucursal")
            ])
                ->with('factura')
        ...
        if($fec1 != ''){
            ...
            $montos = Saipavta::select([
                ...
                DB::raw("(CASE f.TipoFac
                                WHEN 'A' THEN saipavta.pesos
                                WHEN 'Z' THEN saipavta.pesos
                                WHEN 'B' THEN (saipavta.pesos * -1)
                                WHEN 'W' THEN (saipavta.pesos * -1)
                                ELSE 0 END) as pesos"),
                DB::raw("b.descrip as tarjeta"),
                DB::raw("c.descrip as sucursal")
            ])
